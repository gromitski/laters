...
| Export | Implemented as a `v0.6.0` candidate using a versioned, spreadsheet-safe CSV from the main menu. | Published human acceptance remains pending. Import remains a later slice. |
