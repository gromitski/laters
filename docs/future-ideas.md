...
| Export | Released in `v0.6.0` using a versioned, spreadsheet-safe CSV from the main menu. | Published macOS acceptance passed. Import remains a separate `v0.7.0` slice. |
