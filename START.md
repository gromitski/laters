...
Read these in order before repository-dependent work:

- [Working agreements](memory/agreements.md)
...
Laters `v1.1.0` is the current published candidate for optional CSV-supplied reading-time estimates;
installed-application maintainer acceptance remains. Dated design packages, release records and
